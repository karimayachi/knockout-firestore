...
| object | type: [Function] <br><br>A Javascript function that acts as a Model. All koObservable properties of this function will be synced with document properties of the same name.<br><br>For instance: <br><code>var BlogPost = function() {<br>&nbsp;&nbsp;&nbsp;this.title = ko.Observable();<br>&nbsp;&nbsp;&nbsp;this.content = ko.Observable();<br> }</code><br><br>Syncs with a Firestore document:<br><code>{<br>&nbsp;&nbsp;&nbsp;title: 'foo',<br>&nbsp;&nbsp;&nbsp;content: 'bar'<br>}</code>|
