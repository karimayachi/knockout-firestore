...
- [Knockout-Firestore](#knockout-firestore)
  ...
  * [Reference](#reference)
    + [The kofs namespace](#the-kofs-namespace)
      - [getBoundCollection(collection, object [, options])](#getboundcollectioncollection-object--options)
      - [bindCollection(observableArray, collection, object [, options])](#bindCollectionobservablearray-collection-object--options)
